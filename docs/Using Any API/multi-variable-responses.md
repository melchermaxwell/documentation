...
<div class="remix-callout">
    <a href="https://remix.ethereum.org/#optimize=false&evmVersion=null&runs=200&version=soljson-v0.8.6+commit.11564f7e.js&url=https://github.com/smartcontractkit/documentation/tree/main/_src/samples/APIRequests/MultiWordConsumer.sol" target="_blank" class="cl-button--ghost solidity-tracked">Deploy a Multi-Word Contract Example in Remix ↗</a>
